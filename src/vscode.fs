...
module Vscode =
    ...
    module Window =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// <param name="viewId">Id of the view contributed using the extension point `views`.</param>
            /// <param name="options">Options object to provide [TreeDataProvider](#TreeDataProvider) for the view.</param>
            abstract createTreeView: viewId: string * options: CreateTreeViewOptions -> TreeView<'T>
        ...
        type [<AllowNullLiteral>] CreateTreeViewOptions =
